...
## GPT-4 vs Claude 对辩：端到端 or 模块化？谁才是具身智能的正道

*Placeholder—add the debate transcript or your curated debate article here.*

---

### 辩题概要

端到端学习与模块化设计，是具身智能领域的两条主要技术路线。本文记录 GPT-4 与 Claude 对这一问题的对辩，供读者参考与思考。
